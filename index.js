...
async function run(){
    try{
        const appointmentOptionCollection = client.db('doctorsProtal').collection('appointmentOptions');
        ...
        const doctorsCollection = client.db('doctorsProtal').collection('doctors');
